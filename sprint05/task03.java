//  Create class Animal with fields age (int) and weight (double) that can be accessed
//  in the same package only. Animal should have method move without implementation,
//  accessible from everywhere in the application.
//
//  Animal should have a public constructor with parameters age and weight for initialization
